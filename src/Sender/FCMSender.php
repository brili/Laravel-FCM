...
class FCMSender extends HTTPSender
{
     ...
     */
    public function sendTo($to, Options $options = null, PayloadNotification $notification = null, PayloadData $data = null, $dynamicConfig = null)
    {
        $response = null;
        ...
        if (is_array($to) && !empty($to)) {
            ...
            foreach ($partialTokens as $tokens) {
                $request = new Request($tokens, $options, $notification, $data, null, $dynamicConfig);
            ...
            $request = new Request($to, $options, $notification, $data, null, $dynamicConfig);
            $responseGuzzle = $this->post($request);
     ...
     */
    public function sendToGroup($notificationKey, Options $options = null, PayloadNotification $notification = null, PayloadData $data = null, $dynamicConfig = null)
    {
        $request = new Request($notificationKey, $options, $notification, $data, null, $dynamicConfig);
     ...
     */
    public function sendToTopic(Topics $topics, Options $options = null, PayloadNotification $notification = null, PayloadData $data = null, $dynamicConfig = null)
    {
        $request = new Request(null, $options, $notification, $data, $topics, $dynamicConfig);
